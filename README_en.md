...
| 🗞️&nbsp;**Events** | Header `/event` (next to Arb): live news (same telegraph hub) + a local Polymarket watch list (paste event URLs; expand all rungs). Hot board can pin into the watch list. Facts only, no scores |
