...
const FactorPanel = lazy(() =>
  import("@/pages/backtest/FactorPanel").then((m) => ({ default: m.FactorPanel })),
);
const ModelPanel = lazy(() =>
  import("@/pages/backtest/ModelPanel").then((m) => ({ default: m.ModelPanel })),
);
const Tearsheet = lazy(() =>
  import("@/pages/backtest/Tearsheet").then((m) => ({ default: m.Tearsheet })),
);
const EquityChart = lazy(() =>
  import("@/pages/backtest/EquityChart").then((m) => ({ default: m.EquityChart })),
);
